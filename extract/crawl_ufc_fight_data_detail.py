...
def get_fighter_fightDetailIds(FighterLinks):
    FightLink = []
    Fighterr_ID = []

    for fl in tqdm(FighterLinks):
        fighter_url = fl
    ...
    with open('extract/data/outputs/fightLinks.json', 'w') as json_file:
        json.dump(FightLink, json_file)

    return FightLink

def crawl_main_fight_fact(FightLinks):
    ...
    data1 = {'Fighter_ID': Fighter_ID, 'Fight_ID': Fight_ID, 'Fight_Name': Fight_Name, 'Round': Round,
             ...
             'Significant_Strike_pct_0': Significant_Strike_pct_0,
             'Significant_Strike_pct_1': Significant_Strike_pct_1,
             'Total_Strikes_0': Total_Strikes_0, 'Total_Strikes_1': Total_Strikes_1, 'Head_0': Head_0,
             'Head_1': Head_1,
             'Body_0': Body_0,
             'Body_1': Body_1, 'Legs_0': Legs_0, 'Legs_1': Legs_1, 'Distance_0': Distance_0,
...
def crawl_fighter_record_fact(FightLinks):
    ...
    for url in tqdm(FightLinks, desc="Progress of 3rd extract"):
        ...
        try:
            fight_format = \
                page_soup1.findAll("i", {"class", "b-fight-details__text-item"})[2].text.strip().replace("\n     ",
                                                                                                         "").split(
                    ":")[-1]
            Fight_format.append(fight_format.strip())
        except:
            fight_format = ''
        ...
        data2 = {'Fighter_ID': Fighters_ID, 'Fight_ID': Fights_ID, 'Fight_Name': Fights_Name, 'Weight_Class': Weight_Class,
...
def crawl_fight_strike_location_fact(FightLinks):
    ...
    data3 = {'Fighter_ID': Fighters_ID, 'Fight_ID': Fights_ID, 'Fighter_0': Fighter_0, 'Fighter_1': Fighter_1,
