...
fight_outcome_fact =pd.read_csv(r"C:\Users\kalan\PycharmProjects\MMABets\extract\data\database\fight_outcome_fact2.csv", index_col= 0)
...
# ToDo: Additional data processing x2
######################################################
